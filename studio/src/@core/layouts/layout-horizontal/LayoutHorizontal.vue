...
import AppNavbarHorizontalLayoutBrandMobile from "@core/layouts/components/app-navbar/AppNavbarHorizontalLayoutBrandMobile.vue";
...
export default {
  components: {
    ...
    AppNavbarHorizontalLayoutBrandMobile,
    AppFooter,
    HorizontalNavMenu,
